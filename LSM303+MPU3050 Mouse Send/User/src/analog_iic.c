...
* Description    : Master Receive a Byte From Slave
* Input          : None
* Output         : None
* Return         : Date From Slave 
****************************************************************************** */
unsigned char I2C_RecvByte(void)  //数据从高位到低位//
{ 
    u8 i=8;
    u8 ReceiveByte=0;
...
u8 I2C_WriteByte(unsigned char SlaveAddress,unsigned char REG_Address,unsigned char REG_data)		     //void
{
  	if(!I2C_Start())
			return 0;
...
{   unsigned char REG_data;     	
    ...
    I2C_WaitAck();
    I2C_Start();
    I2C_SendByte(SlaveAddress+1);	//SlaveAddress+1
    I2C_WaitAck();
